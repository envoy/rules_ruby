...
load("//ruby/private:bundle_install.bzl", _rb_bundle_gem_install = "rb_bundle_gem_install", _rb_bundle_install = "rb_bundle_install")
...
rb_bundle_gem_install = _rb_bundle_gem_install
